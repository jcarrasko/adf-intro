...
.adf-content-node-selector-dialog .adf-content-node-selector-title::first-letter {
...
.adf-content-node-selector-dialog .adf-content-node-selector-content {
  ...
  .adf-content-node-selector-dialog .adf-content-node-selector-content .mat-input-underline .mat-input-ripple {
    height: 1px;
    transition: none; }
  .adf-content-node-selector-dialog .adf-content-node-selector-content .adf-site-dropdown-container .mat-form-field {
    display: block;
    margin-bottom: 15px; }
  ...
  .adf-content-node-selector-dialog .adf-content-node-selector-content-list {
    ...
    .adf-content-node-selector-dialog .adf-content-node-selector-content-list .adf-data-table {
      ...
      .adf-content-node-selector-dialog .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell {
        ...
        border-top: none;
        height: 30px; }
        .adf-content-node-selector-dialog .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell--image {
          padding-left: 16px;
          padding-right: 8px; }
        .adf-content-node-selector-dialog .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell--text {
          padding-left: 8px; }
...
.adf-content-node-selector-dialog .adf-content-node-selector-actions {
  ...
  color: rgba(0, 0, 0, 0.54); }
  .adf-content-node-selector-dialog .adf-content-node-selector-actions button {
    text-transform: uppercase; }
  ...
  .adf-content-node-selector-dialog .adf-content-node-selector-actions-choose {
    ...
    .adf-content-node-selector-dialog .adf-content-node-selector-actions-choose[disabled] {
      opacity: 0.6; }
    .adf-content-node-selector-dialog .adf-content-node-selector-actions-choose:enabled {
      color: #8bc34a; }
...
.adf-metadata-properties .adf-property {
  display: block;
  margin-bottom: 20px; }
  .adf-metadata-properties .adf-property .adf-property-label {
    display: block;
    padding: 0;
    font-size: 12px;
    color: rgba(0, 0, 0, 0.4); }
  .adf-metadata-properties .adf-property .adf-property-value {
    display: block;
    padding: 0;
    font-size: 14px;
    color: rgba(0, 0, 0, 0.87); }

.adf-viewer-default-sidebar-card-footer.mat-card-footer {
  padding: 8px 12px;
  border-top: 1px solid rgba(0, 0, 0, 0.07); }
  .adf-viewer-default-sidebar-card-footer.mat-card-footer button {
    color: rgba(0, 0, 0, 0.54); }
    .adf-viewer-default-sidebar-card-footer.mat-card-footer button:hover {
      color: rgba(0, 0, 0, 0.87); }
...
.adf-datatable ::ng-deep table {
  ...
  .adf-datatable ::ng-deep table tbody td {
...
.adf-people-search {
  ...
  .adf-people-search .search-list-container {
    ...
    width: 100%;
    overflow-y: auto; }
  .adf-people-search adf-people-list ::ng-deep adf-datatable ::ng-deep thead {
    display: none; }
...
adf-people-list ::ng-deep adf-datatable ::ng-deep .people-email {
  opacity: 0.54; }
...
.adf-dateitem-editable {
  cursor: pointer; }
  .adf-dateitem-editable button.mat-icon-button {
    line-height: 20px;
    height: 20px;
    width: 20px; }
  .adf-dateitem-editable mat-icon {
    width: 16px;
    height: 16px;
    opacity: 0.5;
    margin-left: 4px; }
  .adf-dateitem-editable:hover mat-icon {
    opacity: 1; }
...
.adf-textitem-editable {
  display: flex; }
  .adf-textitem-editable mat-icon:hover {
    opacity: 1;
    cursor: pointer; }
  .adf-textitem-editable mat-form-field {
    width: 100%; }
...
.adf-host-settings {
  ...
  height: 100%;
  align-items: center; }
  .adf-host-settings .adf-setting-toolbar {
    width: 600px; }
