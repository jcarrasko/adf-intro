...
var ContentService = /** @class */ (function () {
    ...
    ContentService.prototype.getNodeContent = function (nodeId) {
        return Observable$1.fromPromise(this.apiService.getInstance().core.nodesApi.getFileContent(nodeId).then(function (dataContent) {
            return dataContent;
...
var NodeDeleteDirective = /** @class */ (function () {
    ...
    NodeDeleteDirective.prototype.process = function (selection) {
        ...
        Observable$1.forkJoin.apply(Observable$1, batch).subscribe(function (data) {
...
var NodeFavoriteDirective = /** @class */ (function () {
    ...
    NodeFavoriteDirective.prototype.toggleFavorite = function () {
        ...
        if (every) {
            var /** @type {?} */ batch = this.favorites.map(function (selected) {
                ...
                return Observable$1.fromPromise(_this.alfrescoApiService.getInstance().core.favoritesApi.removeFavoriteSite('-me-', id));
            });
            Observable$1.forkJoin(batch).subscribe(function () {
    ...
    NodeFavoriteDirective.prototype.markFavoritesNodes = function (selection) {
        ...
        Observable$1.forkJoin(batch).subscribe(function (data) {
...
var NodeRestoreDirective = /** @class */ (function () {
    ...
    NodeRestoreDirective.prototype.restoreNodesBatch = function (batch) {
        var _this = this;
        return Observable$1.forkJoin(batch.map(function (node) { return _this.restoreNode(node); }));
    };
    /**
     * @param {?} selection
     * @return {?}
    ...
    NodeRestoreDirective.prototype.restoreNotification = function () {
        ...
        Observable$1.zip(this.getRestoreMessage(), this.translation.get('CORE.RESTORE_NODE.VIEW')).subscribe(function (messages) {
    ...
    ObjectDataTableAdapter.prototype.formatDate = function (col, value) {
        if (col.type === 'date') {
            ...
            if (format === 'timeAgo') {
                ...
                var /** @type {?} */ datePipe = new DatePipe('en-US');
...
var DataTableComponent = /** @class */ (function () {
    ...
    function DataTableComponent(elementRef, differs) {
        ...
        this.click$ = new Observable$1(function (observer) { return _this.clickObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
...
var FormService = /** @class */ (function () {
    ...
    FormService.prototype.getRestFieldValues = function (taskId, field) {
        var _this = this;
        return Observable$1.fromPromise(this.taskApi.getRestFieldValues(taskId, field)).catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    FormService.prototype.getRestFieldValuesByProcessId = function (processDefinitionId, field) {
        var _this = this;
        return Observable$1.fromPromise(this.processApi.getRestFieldValues(processDefinitionId, field)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} processDefinitionId
     * @param {?} field
    ...
    FormService.prototype.getRestFieldValuesColumnByProcessId = function (processDefinitionId, field, column) {
        var _this = this;
        return Observable$1.fromPromise(this.processApi.getRestTableFieldValues(processDefinitionId, field, column)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} taskId
     * @param {?} field
    ...
    FormService.prototype.getRestFieldValuesColumn = function (taskId, field, column) {
        var _this = this;
        return Observable$1.fromPromise(this.taskApi.getRestFieldValuesColumn(taskId, field, column)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} userId
     * @return {?}
...
var ProcessContentService = /** @class */ (function () {
    ...
    ProcessContentService.prototype.createTemporaryRawRelatedContent = function (file) {
        var _this = this;
        return Observable$1.fromPromise(this.contentApi.createTemporaryRawRelatedContent(file)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} contentId
     * @return {?}
    ...
    ProcessContentService.prototype.getFileContent = function (contentId) {
        var _this = this;
        return Observable$1.fromPromise(this.contentApi.getContent(contentId)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} contentId
     * @return {?}
    ...
    ProcessContentService.prototype.getFileRawContent = function (contentId) {
        var _this = this;
        return Observable$1.fromPromise(this.contentApi.getRawContent(contentId)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} contentId
     * @return {?}
    ...
    ProcessContentService.prototype.getContentThumbnail = function (contentId) {
        var _this = this;
        return Observable$1.fromPromise(this.contentApi.getContentThumbnail(contentId)).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} taskId
     * @return {?}
...
var UploadWidgetComponent = /** @class */ (function (_super) {
    ...
    UploadWidgetComponent.prototype.onFileChanged = function (event) {
        ...
        if (files && files.length > 0) {
            Observable$1.from(files).mergeMap(function (file) { return _this.uploadRawContent(file); }).subscribe(function (res) {
                filesSaved.push(res);
            }, function (error) {
...
var FormFieldComponent = /** @class */ (function () {
    ...
    FormFieldComponent.prototype.createComponentFactorySync = function (compiler, metadata, componentClass) {
        ...
        var /** @type {?} */ decoratedCmp = Component(metadata)(cmpClass);
    ...
    TranslateLoaderService.prototype.getComponentToFetch = function (lang) {
        ...
        this.providers.forEach(function (component) {
            if (!_this.isComponentInQueue(lang, component.name)) {
                ...
                var /** @type {?} */ currentObserv = Observable$1.create(function (observer) {
    ...
    TranslateLoaderService.prototype.getTranslation = function (lang) {
        ...
        return Observable$1.create(function (observer) {
            if (observableBatch.length > 0) {
                Observable$1.forkJoin(observableBatch).subscribe(function () {
 ...
 * limitations under the License.
 */
var minimatch = minimatch___default || minimatch_;
...
//# sourceMappingURL=adf-core.es5.js.map
