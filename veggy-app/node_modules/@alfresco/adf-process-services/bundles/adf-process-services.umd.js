(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser/animations'), require('@alfresco/adf-core'), require('@angular/material'), require('@angular/flex-layout'), require('@ngx-translate/core'), require('rxjs/Observable'), require('rxjs/add/observable/throw'), require('rxjs/Subject'), require('rxjs/add/observable/forkJoin'), require('rxjs/add/observable/fromPromise'), require('rxjs/operator/switchMap'), require('@angular/material/core'), require('moment-es6')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/forms', '@angular/platform-browser/animations', '@alfresco/adf-core', '@angular/material', '@angular/flex-layout', '@ngx-translate/core', 'rxjs/Observable', 'rxjs/add/observable/throw', 'rxjs/Subject', 'rxjs/add/observable/forkJoin', 'rxjs/add/observable/fromPromise', 'rxjs/operator/switchMap', '@angular/material/core', 'moment-es6'], factory) :
	(factory((global['adf-process-services'] = {}),global.ng.common,global.ng.core,global.ng.forms,global['@angular/platform-browser/animations'],global['@alfresco/adf-core'],global['@angular/material'],global['@angular/flex-layout'],global['@ngx-translate/core'],global.Rx,global.Rx.Observable,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global['@angular/material/core'],global['moment-es6']));
}(this, (function (exports,common,core,forms,animations,adfCore,material,flexLayout,core$1,Observable,_throw,Subject,forkJoin,fromPromise,switchMap,core$2,moment$1) { 'use strict';
...
MaterialModule.decorators = [
    { type: core.NgModule, args: [{
                providers: [
                    { provide: material.MAT_PLACEHOLDER_GLOBAL_OPTIONS, useValue: { float: 'never' } }
                ],
                imports: modules(),
                exports: modules()
            },] },
...
var PeopleSearchComponent = /** @class */ (function () {
     ...
     */
    function PeopleSearchComponent(peopleProcessService) {
        var _this = this;
        this.peopleProcessService = peopleProcessService;
        this.searchPeople = new core.EventEmitter();
        this.success = new core.EventEmitter();
        this.closeSearch = new core.EventEmitter();
...
PeopleSearchComponent.ctorParameters = function () { return [
    { type: adfCore.PeopleProcessService, },
]; };
PeopleSearchComponent.propDecorators = {
    'results': [{ type: core.Input },],
    'searchPeople': [{ type: core.Output },],
    'success': [{ type: core.Output },],
    'closeSearch': [{ type: core.Output },],
};
...
PeopleSearchTitleDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'people-search-title' },] },
];
/**
 * @nocollapse
 */
PeopleSearchTitleDirective.ctorParameters = function () { return []; };
...
PeopleSearchActionLabelDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'people-search-action-label' },] },
];
/**
 * @nocollapse
 */
PeopleSearchActionLabelDirective.ctorParameters = function () { return []; };
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 *
...
var PeopleComponent = /** @class */ (function () {
    ...
    function PeopleComponent(logService, peopleProcessService) {
        ...
        this.peopleSearch$ = new Observable.Observable(function (observer) { return _this.peopleSearchObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
...
PeopleComponent.propDecorators = {
    'people': [{ type: core.Input },],
    'taskId': [{ type: core.Input },],
    'readOnly': [{ type: core.Input },],
    'peopleSearch': [{ type: core.ViewChild, args: [PeopleSearchComponent,] },],
};
/**
 *
 ...
 *
 */
var UserEventModel = /** @class */ (function () {
    /**
     * @param {?=} obj
     */
...
var PeopleListComponent = /** @class */ (function () {
    ...
    PeopleListComponent.prototype.onExecuteRowAction = function (event) {
        var /** @type {?} */ args = event.value;
        var /** @type {?} */ action = args.action;
...
PeopleListComponent.propDecorators = {
    ...
    'peopleDataTable': [{ type: core.ViewChild, args: [adfCore.DataTableComponent,] },],
 ...
 * @nocollapse
 */
PeopleModule.ctorParameters = function () { return []; };
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 *
...
var ProcessCommentsComponent = /** @class */ (function () {
    ...
    ProcessCommentsComponent.prototype.ngOnChanges = function (changes) {
        var /** @type {?} */ processInstanceId = changes['processInstanceId'];
        ...
        if (processInstanceId) {
            this.commentProcessService.getProcessInstanceComments(processInstanceId).subscribe(function (res) {
                res = res.sort(function (comment1, comment2) {
                    var /** @type {?} */ date1 = new Date(comment1.created);
                    var /** @type {?} */ date2 = new Date(comment2.created);
...
ProcessCommentsComponent.ctorParameters = function () { return [
    { type: adfCore.CommentProcessService, },
]; };
...
var CommentListComponent = /** @class */ (function () {
     ...
     * @param {?} peopleProcessService
     */
    function CommentListComponent(datePipe, peopleProcessService) {
    ...
    CommentListComponent.prototype.transformDate = function (aDate) {
        var /** @type {?} */ formattedDate;
        var /** @type {?} */ givenDate = Number.parseInt(this.datePipe.transform(aDate, 'yMMdd'));
        var /** @type {?} */ today = Number.parseInt(this.datePipe.transform(Date.now(), 'yMMdd'));
        if (givenDate === today) {
            formattedDate = 'Today, ' + this.datePipe.transform(aDate, 'hh:mm a');
        }
        else {
            var /** @type {?} */ yesterday = Number.parseInt(this.datePipe.transform(Date.now() - 24 * 3600 * 1000, 'yMMdd'));
...
var CommentsComponent = /** @class */ (function () {
     ...
     * @param {?} commentProcessService
     */
    function CommentsComponent(commentProcessService) {
        var _this = this;
        this.commentProcessService = commentProcessService;
        this.readOnly = false;
        this.error = new core.EventEmitter();
    ...
    CommentsComponent.prototype.getTaskComments = function (taskId) {
        ...
        this.resetComments();
        if (taskId) {
            this.commentProcessService.getTaskComments(taskId).subscribe(function (res) {
                res = res.sort(function (comment1, comment2) {
                    var /** @type {?} */ date1 = new Date(comment1.created);
                    var /** @type {?} */ date2 = new Date(comment2.created);
                    return date1 > date2 ? -1 : date1 < date2 ? 1 : 0;
...
var TaskUploadService = /** @class */ (function (_super) {
    ...
    TaskUploadService.prototype.getUploadPromise = function (file) {
        ...
        var /** @type {?} */ taskId = file.options.parentId;
        var /** @type {?} */ promise = this.instanceApi.getInstance().activiti.contentApi.createRelatedContentOnTask(taskId, file.file, opts);
...
var ProcessUploadService = /** @class */ (function (_super) {
    ...
    ProcessUploadService.prototype.getUploadPromise = function (file) {
        ...
        var /** @type {?} */ processInstanceId = file.options.parentId;
        var /** @type {?} */ promise = this.instanceApi.getInstance().activiti.contentApi.createRelatedContentOnProcessInstance(processInstanceId, file.file, opts);
        promise.catch(function (err) { return _this.handleError(err); });
        return promise;
    };
    /**
...
var FilterParamRepresentationModel = /** @class */ (function () {
    /**
     * @param {?=} obj
     */
...
var TaskQueryRequestRepresentationModel = /** @class */ (function () {
    /**
     * @param {?=} obj
     */
...
var TaskDetailsModel = /** @class */ (function () {
    ...
    function TaskDetailsModel(obj) {
        ...
        if (obj) {
            ...
            this.assignee = obj.assignee ? new adfCore.UserProcessModel(obj.assignee) : null;
    ...
    TaskDetailsModel.prototype.getFullName = function () {
        var /** @type {?} */ fullName = '';
        if (this.assignee) {
            var /** @type {?} */ firstName = this.assignee.firstName ? this.assignee.firstName : '';
            var /** @type {?} */ lastName = this.assignee.lastName ? this.assignee.lastName : '';
...
var TaskListService = /** @class */ (function () {
    ...
    function TaskListService(apiService, logService) {
        ...
        this.logService = logService;
        this.tasksListSubject = new Subject.Subject();
    ...
    TaskListService.prototype.getFilterForTaskById = function (taskId, filterList) {
        var _this = this;
        return Observable.Observable.from(filterList)
    ...
    TaskListService.prototype.isTaskRelatedToFilter = function (taskId, filter) {
        var _this = this;
        var /** @type {?} */ requestNodeForFilter = this.generateTaskRequestNodeFromFilter(filter);
        return Observable.Observable.fromPromise(this.callApiTasksFiltered(requestNodeForFilter))
            .map(function (res) {
    ...
    TaskListService.prototype.getTasks = function (requestNode) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiTasksFiltered(requestNode))
            .map(function (res) {
    ...
    TaskListService.prototype.findAllTaskByState = function (requestNode, state) {
        ...
        return this.getTotalTasks(requestNode).switchMap(function (res) {
    ...
    TaskListService.prototype.findAllTasksWithoutState = function (requestNode) {
        var _this = this;
        return Observable.Observable.forkJoin(this.findTasksByState(requestNode, 'open'), this.findAllTaskByState(requestNode, 'completed'), function (activeTasks, completedTasks) {
            var /** @type {?} */ tasks = Object.assign({}, activeTasks);
            tasks.total += completedTasks.total;
            tasks.data = tasks.data.concat(completedTasks.data);
            _this.tasksListSubject.next(tasks);
            return tasks;
        });
    };
    /**
    ...
    TaskListService.prototype.getTaskDetails = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiTaskDetails(taskId))
    ...
    TaskListService.prototype.getTaskChecklist = function (id) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiTaskChecklist(id))
            .map(function (res) { return res; })
    ...
    TaskListService.prototype.getFormList = function () {
        ...
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.modelsApi.getModels(opts)).map(function (res) { return res; })
            .map(function (response) {
            var /** @type {?} */ forms$$1 = [];
    ...
    TaskListService.prototype.attachFormToATask = function (taskId, formId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.attachForm(taskId, { 'formId': formId })).catch(function (err) { return _this.handleError(err); });
    };
    /**
     * Add a task
    ...
    TaskListService.prototype.addTask = function (task) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiAddTask(task))
            .map(function (res) { return res; })
            .map(function (response) {
    ...
    TaskListService.prototype.deleteTask = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiDeleteTask(taskId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    TaskListService.prototype.completeTask = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.completeTask(taskId))
            .map(function (res) { return res; })
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    TaskListService.prototype.createNewTask = function (task) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiCreateTask(task))
            .map(function (res) { return res; })
            .map(function (response) {
            return new TaskDetailsModel(response);
        }).catch(function (err) { return _this.handleError(err); });
    ...
    TaskListService.prototype.assignTask = function (taskId, requestNode) {
        var _this = this;
        var /** @type {?} */ assignee = { assignee: requestNode.id };
        return Observable.Observable.fromPromise(this.callApiAssignTask(taskId, assignee))
            .map(function (res) { return res; })
            .map(function (response) {
            return new TaskDetailsModel(response);
        }).catch(function (err) { return _this.handleError(err); });
    ...
    TaskListService.prototype.assignTaskByUserId = function (taskId, userId) {
        var _this = this;
        var /** @type {?} */ assignee = { assignee: userId };
        return Observable.Observable.fromPromise(this.callApiAssignTask(taskId, assignee))
            .map(function (res) { return res; })
            .map(function (response) {
            return new TaskDetailsModel(response);
    ...
    TaskListService.prototype.claimTask = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.claimTask(taskId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
     * Unclaim a task
    ...
    TaskListService.prototype.unclaimTask = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.unclaimTask(taskId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
     * Update due date
    ...
    TaskListService.prototype.updateTask = function (taskId, updated) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.updateTask(taskId, updated))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    TaskListService.prototype.fetchTaskAuditPdfById = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.getTaskAuditPdf(taskId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    TaskListService.prototype.fetchTaskAuditJsonById = function (taskId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.taskApi.getTaskAuditJson(taskId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
     * @param {?} requestNode
...
var TaskFilterService = /** @class */ (function () {
    ...
    TaskFilterService.prototype.createDefaultFilters = function (appId) {
        var _this = this;
        var /** @type {?} */ involvedTasksFilter = this.getInvolvedTasksFilterInstance(appId);
        var /** @type {?} */ involvedObservable = this.addFilter(involvedTasksFilter);
        var /** @type {?} */ myTasksFilter = this.getMyTasksFilterInstance(appId);
        var /** @type {?} */ myTaskObservable = this.addFilter(myTasksFilter);
        var /** @type {?} */ queuedTasksFilter = this.getQueuedTasksFilterInstance(appId);
        var /** @type {?} */ queuedObservable = this.addFilter(queuedTasksFilter);
        var /** @type {?} */ completedTasksFilter = this.getCompletedTasksFilterInstance(appId);
        var /** @type {?} */ completeObservable = this.addFilter(completedTasksFilter);
        return Observable.Observable.create(function (observer) {
            Observable.Observable.forkJoin(involvedObservable, myTaskObservable, queuedObservable, completeObservable).subscribe(function (res) {
                var /** @type {?} */ filters = [];
    ...
    TaskFilterService.prototype.getTaskListFilters = function (appId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiTaskFilters(appId))
            .map(function (response) {
            var /** @type {?} */ filters = [];
            response.data.forEach(function (filter) {
                var /** @type {?} */ filterModel = new FilterRepresentationModel(filter);
    ...
    TaskFilterService.prototype.addFilter = function (filter) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().activiti.userFiltersApi.createUserTaskFilter(filter))
            .map(function (res) { return res; })
            .map(function (response) {
            return response;
        }).catch(function (err) { return _this.handleError(err); });
     ...
     * @return {?}
     */
    TaskFilterService.prototype.getInvolvedTasksFilterInstance = function (appId) {
     ...
     * @return {?}
     */
    TaskFilterService.prototype.getMyTasksFilterInstance = function (appId) {
        return new FilterRepresentationModel({
            'name': 'My Tasks',
            'appId': appId,
            'recent': false,
     ...
     * @return {?}
     */
    TaskFilterService.prototype.getQueuedTasksFilterInstance = function (appId) {
        return new FilterRepresentationModel({
            'name': 'Queued Tasks',
            'appId': appId,
            'recent': false,
     ...
     * @return {?}
     */
    TaskFilterService.prototype.getCompletedTasksFilterInstance = function (appId) {
        return new FilterRepresentationModel({
...
var ChecklistComponent = /** @class */ (function () {
    ...
    function ChecklistComponent(activitiTaskList, dialog) {
        ...
        this.dialog = dialog;
        this.readOnly = false;
        this.checklistTaskCreated = new core.EventEmitter();
        this.checklistTaskDeleted = new core.EventEmitter();
        this.error = new core.EventEmitter();
        this.checklist = [];
        this.task$ = new Observable.Observable(function (observer) { return _this.taskObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
    ...
    ChecklistComponent.prototype.add = function () {
        var _this = this;
        var /** @type {?} */ newTask = new TaskDetailsModel({
            name: this.taskName,
...
ChecklistComponent.propDecorators = {
    'taskId': [{ type: core.Input },],
    'readOnly': [{ type: core.Input },],
    'assignee': [{ type: core.Input },],
    'checklistTaskCreated': [{ type: core.Output },],
    'checklistTaskDeleted': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'addNewDialog': [{ type: core.ViewChild, args: ['dialog',] },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var TaskDetailsComponent = /** @class */ (function () {
    ...
    function TaskDetailsComponent(taskListService, authService, peopleProcessService, logService, cardViewUpdateService, dialog) {
        ...
        this.taskCreated = new core.EventEmitter();
        this.taskDeleted = new core.EventEmitter();
        this.error = new core.EventEmitter();
        this.executeOutcome = new core.EventEmitter();
        this.assignTask = new core.EventEmitter();
            ...
            this.taskListService.getTaskDetails(taskId).subscribe(function (res) {
                ...
                if (_this.taskDetails && _this.taskDetails.involvedPeople) {
                    _this.taskDetails.involvedPeople.forEach(function (user) {
                        _this.taskPeople.push(new adfCore.UserProcessModel(user));
                    });
                }
            });
        }
    ...
    TaskDetailsComponent.prototype.loadNextTask = function (processInstanceId, processDefinitionId) {
        var _this = this;
        var /** @type {?} */ requestNode = new TaskQueryRequestRepresentationModel({
...
TaskDetailsComponent.propDecorators = {
    'activiticomments': [{ type: core.ViewChild, args: ['activiticomments',] },],
    'activitichecklist': [{ type: core.ViewChild, args: ['activitichecklist',] },],
    'errorDialog': [{ type: core.ViewChild, args: ['errorDialog',] },],
    'debugMode': [{ type: core.Input },],
    'taskId': [{ type: core.Input },],
    'showNextTask': [{ type: core.Input },],
    'showHeader': [{ type: core.Input },],
    'showHeaderContent': [{ type: core.Input },],
    'showInvolvePeople': [{ type: core.Input },],
    'showComments': [{ type: core.Input },],
    'showChecklist': [{ type: core.Input },],
    'showFormTitle': [{ type: core.Input },],
    'showFormCompleteButton': [{ type: core.Input },],
    'showFormSaveButton': [{ type: core.Input },],
    'readOnlyForm': [{ type: core.Input },],
    'showFormRefreshButton': [{ type: core.Input },],
    ...
    'taskCreated': [{ type: core.Output },],
    'taskDeleted': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'executeOutcome': [{ type: core.Output },],
    'assignTask': [{ type: core.Output },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var StartTaskModel = /** @class */ (function () {
    ...
    function StartTaskModel(obj) {
        ...
        this.assignee = obj && obj.assignee ? new adfCore.UserProcessModel(obj.assignee) : null;
...
var StartTaskComponent = /** @class */ (function () {
     ...
     * @param {?} logService
     */
    function StartTaskComponent(taskService, peopleService, dateAdapter, preferences, logService) {
    ...
    StartTaskComponent.prototype.start = function () {
        ...
        if (this.startTaskmodel.name) {
            ...
            this.taskService.createNewTask(new TaskDetailsModel(this.startTaskmodel))
                .switchMap(function (createRes) { return _this.attachForm(createRes.id, _this.formKey).defaultIfEmpty(createRes)
                .switchMap(function (attachRes) { return _this.assignTaskByUserId(createRes.id, _this.assigneeId).defaultIfEmpty(attachRes ? attachRes : createRes); }); })
                .subscribe(function (res) {
    ...
    StartTaskComponent.prototype.attachForm = function (taskId, formKey) {
        var /** @type {?} */ response = Observable.Observable.of();
        if (taskId && formKey) {
    ...
    StartTaskComponent.prototype.onDateChanged = function (newDateValue) {
        ...
        if (newDateValue) {
            var /** @type {?} */ momentDate = moment$1(newDateValue, this.FORMAT_DATE, true);
...
StartTaskComponent.decorators = [
    { type: core.Component, args: [{
                ...
                styles: ["\n\n    "],
                providers: [
                    { provide: core$2.DateAdapter, useClass: adfCore.MomentDateAdapter },
                    { provide: core$2.MAT_DATE_FORMATS, useValue: adfCore.MOMENT_DATE_FORMATS }
                ],
                encapsulation: core.ViewEncapsulation.None
            },] },
];
...
TaskAuditDirective.propDecorators = {
    'taskId': [{ type: core.Input, args: ['task-id',] },],
...
var TaskFiltersComponent = /** @class */ (function () {
    ...
    function TaskFiltersComponent(taskFilterService, taskListService, appsProcessService) {
        ...
        this.hasIcon = true;
        this.filters = [];
        this.filter$ = new Observable.Observable(function (observer) { return _this.filterObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
    ...
    TaskFiltersComponent.prototype.ngOnChanges = function (changes) {
        var /** @type {?} */ appId = changes['appId'];
        if (appId && (appId.currentValue || appId.currentValue === null)) {
            this.getFiltersByAppId(appId.currentValue);
            return;
        }
        var /** @type {?} */ appName = changes['appName'];
    ...
    TaskFiltersComponent.prototype.getFiltersByAppId = function (appId) {
        ...
        this.taskFilterService.getTaskListFilters(appId).subscribe(function (res) {
            if (res.length === 0 && _this.isFilterListEmpty()) {
                _this.taskFilterService.createDefaultFilters(appId).subscribe(function (resDefault) {
                    _this.resetFilter();
    ...
    TaskFiltersComponent.prototype.selectFilterWithTask = function (taskId) {
        ...
        this.taskListService.getFilterForTaskById(taskId, this.filters).subscribe(function (filter) {
            ...
            if (filteredFilterList.length > 0) {
                _this.selectTaskFilter(new FilterParamsModel({ name: 'My Tasks' }), filteredFilterList);
...
TaskFiltersComponent.ctorParameters = function () { return [
    ...
    { type: TaskListService, },
    { type: adfCore.AppsProcessService, },
]; };
TaskFiltersComponent.propDecorators = {
    'filterParam': [{ type: core.Input },],
...
var TaskHeaderComponent = /** @class */ (function () {
     ...
     * @param {?} logService
     */
    function TaskHeaderComponent(activitiTaskService, bpmUserService, logService) {
        this.activitiTaskService = activitiTaskService;
        this.bpmUserService = bpmUserService;
        this.logService = logService;
        this.formName = null;
        this.claim = new core.EventEmitter();
        this.unclaim = new core.EventEmitter();
        this.inEdit = false;
    }
    /**
     * @return {?}
    ...
    TaskHeaderComponent.prototype.refreshData = function () {
        if (this.taskDetails) {
            var /** @type {?} */ parentInfoMap = this.getParentInfo();
            this.properties = [
                ...
                new adfCore.CardViewMapItemModel({
     ...
     * @return {?}
     */
    TaskHeaderComponent.prototype.unclaimTask = function (taskId) {
        var _this = this;
...
TaskHeaderComponent.ctorParameters = function () { return [
    { type: TaskListService, },
    { type: adfCore.BpmUserService, },
    { type: adfCore.LogService, },
]; };
TaskHeaderComponent.propDecorators = {
    'formName': [{ type: core.Input },],
    'taskDetails': [{ type: core.Input },],
    'claim': [{ type: core.Output },],
    'unclaim': [{ type: core.Output },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var TaskListComponent = /** @class */ (function () {
     ...
     * @param {?} appConfig
     */
    function TaskListComponent(taskListService, appConfig) {
        this.taskListService = taskListService;
        this.appConfig = appConfig;
        this.selectionMode = 'single'; // none|single|multiple
        this.multiselect = false;
        this.rowClick = new core.EventEmitter();
        this.rowsSelected = new core.EventEmitter();
        this.success = new core.EventEmitter();
        this.error = new core.EventEmitter();
        this.layoutPresets = {};
        this.page = 0;
    ...
    TaskListComponent.prototype.ngOnInit = function () {
        if (this.data === undefined) {
            this.data = new adfCore.ObjectDataTableAdapter();
        }
        this.initStream();
    };
    /**
    ...
    TaskListComponent.prototype.setupSchema = function () {
        ...
        if (this.columnList && this.columnList.columns && this.columnList.columns.length > 0) {
            schema = this.columnList.columns.map(function (c) { /** @type {?} */ return (c); });
        }
        if (!this.data) {
            this.data = new adfCore.ObjectDataTableAdapter([], schema.length > 0 ? schema : this.presetColumn ? this.getLayoutPreset(this.presetColumn) : this.getLayoutPreset());
        }
        else {
    ...
    TaskListComponent.prototype.isPropertyChanged = function (changes) {
        var /** @type {?} */ changed = true;
        var /** @type {?} */ landingTaskId = changes['landingTaskId'];
    ...
    TaskListComponent.prototype.createDataRow = function (instances) {
        var /** @type {?} */ instancesRows = [];
        instances.forEach(function (row) {
            instancesRows.push(new adfCore.ObjectDataRow(row));
        });
    ...
    TaskListComponent.prototype.selectTask = function (taskIdSelected) {
        if (!this.isListEmpty()) {
            ...
            if (rows.length > 0) {
                var /** @type {?} */ dataRow = void 0;
                if (taskIdSelected) {
                    dataRow = rows.find(function (currentRow) {
    ...
    TaskListComponent.prototype.onRowSelect = function (event) {
        this.selectedInstances = event.detail.selection.slice();
     ...
     * @return {?}
     */
    TaskListComponent.prototype.setupDefaultColumns = function (preset) {
        if (preset === void 0) { preset = 'default'; }
        if (this.data) {
            var /** @type {?} */ columns = this.getLayoutPreset(preset);
     ...
     * @return {?}
     */
    TaskListComponent.prototype.loadLayoutPresets = function () {
        var /** @type {?} */ externalSettings = this.appConfig.get('adf-task-list.presets', null);
        if (externalSettings) {
     ...
     * @return {?}
     */
    TaskListComponent.prototype.getLayoutPreset = function (name) {
...
TaskListComponent.propDecorators = {
    ...
    'appId': [{ type: core.Input },],
    'processInstanceId': [{ type: core.Input },],
    'processDefinitionKey': [{ type: core.Input },],
    'state': [{ type: core.Input },],
    'assignment': [{ type: core.Input },],
    'sort': [{ type: core.Input },],
    'name': [{ type: core.Input },],
    'landingTaskId': [{ type: core.Input },],
    'data': [{ type: core.Input },],
    'selectionMode': [{ type: core.Input },],
    'presetColumn': [{ type: core.Input },],
    'multiselect': [{ type: core.Input },],
    'rowClick': [{ type: core.Output },],
    'rowsSelected': [{ type: core.Output },],
    'success': [{ type: core.Output },],
    'error': [{ type: core.Output },],
 ...
 * @nocollapse
 */
TaskListModule.ctorParameters = function () { return []; };
...
var ProcessService = /** @class */ (function () {
    ...
    ProcessService.prototype.getProcessInstances = function (requestNode, processDefinitionKey) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.getProcessInstances(requestNode))
            .map(function (res) {
    ...
    ProcessService.prototype.fetchProcessAuditPdfById = function (processId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.getProcessAuditPdf(processId))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
    ...
    ProcessService.prototype.fetchProcessAuditJsonById = function (processId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.getProcessAuditJson(processId))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.getProcess = function (processInstanceId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.getProcessInstance(processInstanceId))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.getProcessTasks = function (processInstanceId, state) {
        var _this = this;
        var /** @type {?} */ taskOpts = state ? {
            processInstanceId: processInstanceId,
            state: state
        } : {
            processInstanceId: processInstanceId
        };
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.taskApi.listTasks(taskOpts))
    ...
    ProcessService.prototype.getProcessDefinitions = function (appId) {
        ...
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.getProcessDefinitions(opts))
            .map(this.extractData)
            .map(function (processDefs) { return processDefs.map(function (pd) { return new ProcessDefinitionRepresentation(pd); }); })
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processDefinitionId
    ...
    ProcessService.prototype.startProcess = function (processDefinitionId, name, outcome, startFormValues, variables) {
        ...
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.startNewProcessInstance(startRequest))
            .map(function (pd) { return new ProcessInstance(pd); })
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.cancelProcess = function (processInstanceId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processApi.deleteProcessInstance(processInstanceId))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.getProcessInstanceVariables = function (processInstanceId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processInstanceVariablesApi.getProcessInstanceVariables(processInstanceId))
            .map(function (processVars) { return processVars.map(function (pd) { return new ProcessInstanceVariable(pd); }); })
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.createOrUpdateProcessInstanceVariables = function (processInstanceId, variables) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processInstanceVariablesApi.createOrUpdateProcessInstanceVariables(processInstanceId, variables))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} processInstanceId
    ...
    ProcessService.prototype.deleteProcessInstanceVariable = function (processInstanceId, variableName) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.processInstanceVariablesApi.deleteProcessInstanceVariable(processInstanceId, variableName))
            .catch(function (err) { return _this.handleProcessError(err); });
    };
    /**
     * @param {?} res
...
ProcessAuditDirective.propDecorators = {
    'processId': [{ type: core.Input, args: ['process-id',] },],
    'fileName': [{ type: core.Input },],
    'format': [{ type: core.Input },],
    'download': [{ type: core.Input },],
    'clicked': [{ type: core.Output },],
...
var ProcessFilterService = /** @class */ (function () {
    ...
    ProcessFilterService.prototype.getProcessFilters = function (appId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.callApiProcessFilters(appId))
            .map(function (response) {
            var /** @type {?} */ filters = [];
            response.data.forEach(function (filter) {
                var /** @type {?} */ filterModel = new FilterProcessRepresentationModel(filter);
                filters.push(filterModel);
            });
            return filters;
        })
    ...
    ProcessFilterService.prototype.createDefaultFilters = function (appId) {
        var _this = this;
        var /** @type {?} */ runningFilter = this.getRunningFilterInstance(appId);
        var /** @type {?} */ runningObservable = this.addProcessFilter(runningFilter);
        var /** @type {?} */ completedFilter = this.getCompletedFilterInstance(appId);
        var /** @type {?} */ completedObservable = this.addProcessFilter(completedFilter);
        var /** @type {?} */ allFilter = this.getAllFilterInstance(appId);
        var /** @type {?} */ allObservable = this.addProcessFilter(allFilter);
        return Observable.Observable.create(function (observer) {
            Observable.Observable.forkJoin(runningObservable, completedObservable, allObservable).subscribe(function (res) {
                var /** @type {?} */ filters = [];
                res.forEach(function (filter) {
     ...
     * @return {?}
     */
    ProcessFilterService.prototype.getRunningFilterInstance = function (appId) {
     ...
     * @return {?}
     */
    ProcessFilterService.prototype.getCompletedFilterInstance = function (appId) {
        return new FilterProcessRepresentationModel({
            'name': 'Completed',
            'appId': appId,
            'recent': false,
     ...
     * @return {?}
     */
    ProcessFilterService.prototype.getAllFilterInstance = function (appId) {
        return new FilterProcessRepresentationModel({
            'name': 'All',
            'appId': appId,
            'recent': true,
    ...
    ProcessFilterService.prototype.addProcessFilter = function (filter) {
        var _this = this;
        return Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().activiti.userFiltersApi.createUserProcessInstanceFilter(filter))
            .map(function (res) { return res; })
            .map(function (response) {
            return response;
        }).catch(function (err) { return _this.handleProcessError(err); });
    ...
    ProcessInstanceHeaderComponent.prototype.refreshData = function () {
        if (this.processInstance) {
            this.properties = [
                ...
                new adfCore.CardViewTextItemModel({ label: 'ADF_PROCESS_LIST.PROPERTIES.ID',
                    value: this.processInstance.id,
                    key: 'id'
                }),
                new adfCore.CardViewTextItemModel({ label: 'ADF_PROCESS_LIST.PROPERTIES.DESCRIPTION',
...
ProcessInstanceHeaderComponent.propDecorators = {
    'processInstance': [{ type: core.Input },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var ProcessInstanceTasksComponent = /** @class */ (function () {
    ...
    function ProcessInstanceTasksComponent(activitiProcess, logService, dialog) {
        ...
        this.activeTasks = [];
        this.completedTasks = [];
        this.taskClick = new core.EventEmitter();
        this.task$ = new Observable.Observable(function (observer) { return _this.taskObserver = observer; }).share();
        this.completedTask$ = new Observable.Observable(function (observer) { return _this.completedTaskObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
    ...
    ProcessInstanceTasksComponent.prototype.ngOnChanges = function (changes) {
        var /** @type {?} */ processInstanceDetails = changes['processInstanceDetails'];
    ...
    ProcessInstanceTasksComponent.prototype.clickTask = function ($event, task) {
        var /** @type {?} */ args = new TaskDetailsEvent(task);
...
ProcessInstanceTasksComponent.propDecorators = {
    'processInstanceDetails': [{ type: core.Input },],
    'showRefreshButton': [{ type: core.Input },],
    'error': [{ type: core.Output },],
    'startDialog': [{ type: core.ViewChild, args: ['startDialog',] },],
    'taskdetails': [{ type: core.ViewChild, args: ['taskdetails',] },],
    'taskClick': [{ type: core.Output },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var ProcessInstanceDetailsComponent = /** @class */ (function () {
    ...
    function ProcessInstanceDetailsComponent(activitiProcess, logService) {
        ...
        this.showTitle = true;
        this.showRefreshButton = true;
        this.processCancelled = new core.EventEmitter();
        this.error = new core.EventEmitter();
        this.taskClick = new core.EventEmitter();
        this.showProcessDiagram = new core.EventEmitter();
    }
    /**
     * @param {?} changes
     * @return {?}
...
ProcessInstanceDetailsComponent.propDecorators = {
    'processInstanceId': [{ type: core.Input },],
    'processInstanceHeader': [{ type: core.ViewChild, args: [ProcessInstanceHeaderComponent,] },],
    'tasksList': [{ type: core.ViewChild, args: [ProcessInstanceTasksComponent,] },],
    'showTitle': [{ type: core.Input },],
    'showRefreshButton': [{ type: core.Input },],
    'processCancelled': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'taskClick': [{ type: core.Output },],
    'showProcessDiagram': [{ type: core.Output },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 ...
 * limitations under the License.
 */
var ProcessInstanceListComponent = /** @class */ (function () {
    /**
    ...
    ProcessInstanceListComponent.prototype.setupSchema = function () {
        ...
        if (!this.data) {
            this.data = new adfCore.ObjectDataTableAdapter([], schema.length > 0 ? schema : this.getLayoutPreset(this.presetColumn));
        }
        else {
            if (schema && schema.length > 0) {
                this.data.setColumns(schema);
    ...
    ProcessInstanceListComponent.prototype.isPropertyChanged = function (changes) {
        ...
        var /** @type {?} */ appId = changes['appId'];
        var /** @type {?} */ processDefinitionKey = changes['processDefinitionKey'];
        var /** @type {?} */ state = changes['state'];
        var /** @type {?} */ sort = changes['sort'];
        var /** @type {?} */ name = changes['name'];
    ...
    ProcessInstanceListComponent.prototype.load = function (requestNode) {
        ...
        this.processService.getProcessInstances(requestNode, this.processDefinitionKey)
            ...
            var /** @type {?} */ instancesRow = _this.createDataRow(response);
            _this.renderInstances(instancesRow);
            _this.selectFirst();
    ...
    ProcessInstanceListComponent.prototype.setDatatableSorting = function () {
        ...
        var /** @type {?} */ sortingParams = this.sort.split('-');
        if (sortingParams.length === 2) {
            var /** @type {?} */ sortColumn = sortingParams[0] === 'created' ? 'started' : sortingParams[0];
            var /** @type {?} */ sortOrder = sortingParams[1];
            this.data.setSorting(new adfCore.DataSorting(sortColumn, sortOrder));
        }
    };
    /**
    ...
    ProcessInstanceListComponent.prototype.selectFirst = function () {
        if (!this.isListEmpty()) {
            var /** @type {?} */ row = this.data.getRows()[0];
            row.isSelected = true;
    ...
    ProcessInstanceListComponent.prototype.loadLayoutPresets = function () {
        var /** @type {?} */ externalSettings = this.appConfig.get('adf-process-list.presets', null);
        if (externalSettings) {
...
var StartProcessInstanceComponent = /** @class */ (function () {
    ...
    StartProcessInstanceComponent.prototype.ngOnChanges = function (changes) {
        var /** @type {?} */ appIdChange = changes['appId'];
        var /** @type {?} */ appId = appIdChange ? appIdChange.currentValue : null;
        this.load(appId);
    };
    /**
     * @param {?=} appId
    ...
    StartProcessInstanceComponent.prototype.startProcess = function (outcome) {
        ...
        if (this.currentProcessDef.id && this.name) {
            this.resetErrorMessage();
            var /** @type {?} */ formValues = this.startForm ? this.startForm.form.values : undefined;
    ...
    StartProcessInstanceComponent.prototype.onProcessDefChange = function (processDefinitionId) {
        var /** @type {?} */ processDef = this.processDefinitions.find(function (processDefinition) {
...
StartProcessInstanceComponent.propDecorators = {
    'appId': [{ type: core.Input },],
    'variables': [{ type: core.Input },],
    'start': [{ type: core.Output },],
    'cancel': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'startForm': [{ type: core.ViewChild, args: [adfCore.StartFormComponent,] },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 ...
 * @nocollapse
 */
ProcessListModule.ctorParameters = function () { return []; };
...
var AppsListComponent = /** @class */ (function () {
    ...
    function AppsListComponent(appsProcessService, translationService) {
        ...
        this.appClick = new core.EventEmitter();
        this.error = new core.EventEmitter();
        this.appList = [];
        this.apps$ = new Observable.Observable(function (observer) { return _this.appsObserver = observer; }).share();
    }
    /**
     * @return {?}
     */
    ...
    AppsListComponent.prototype.getAppName = function (app) {
        return this.isDefaultApp(app)
            ...
            : Observable.Observable.of(app.name);
    };
    /**
...
AppsListComponent.propDecorators = {
    ...
    'filtersAppId': [{ type: core.Input },],
    'appClick': [{ type: core.Output },],
    'error': [{ type: core.Output },],
};
/*!
 * @license
 ...
 * @nocollapse
 */
AppsListModule.ctorParameters = function () { return []; };
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 *
...
var TaskAttachmentListComponent = /** @class */ (function () {
    ...
    function TaskAttachmentListComponent(activitiContentService, contentService, thumbnailService, ngZone) {
        ...
        this.ngZone = ngZone;
        this.disabled = false;
        this.attachmentClick = new core.EventEmitter();
        this.success = new core.EventEmitter();
        this.error = new core.EventEmitter();
     ...
     * @return {?}
     */
    TaskAttachmentListComponent.prototype.hasCutomEmptyTemplate = function () {
    ...
    TaskAttachmentListComponent.prototype.openContent = function (event) {
        var /** @type {?} */ content = event.value.obj;
...
TaskAttachmentListComponent.ctorParameters = function () { return [
    { type: adfCore.ProcessContentService, },
    { type: adfCore.ContentService, },
    { type: adfCore.ThumbnailService, },
    { type: core.NgZone, },
]; };
TaskAttachmentListComponent.propDecorators = {
    'emptyTemplate': [{ type: core.ContentChild, args: [adfCore.EmptyListComponent,] },],
    'taskId': [{ type: core.Input },],
    'disabled': [{ type: core.Input },],
    'attachmentClick': [{ type: core.Output },],
    'success': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'customTemplateRef': [{ type: core.ViewChild, args: ['customEmptyListTemplate',] },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
ProcessAttachmentListComponent.propDecorators = {
    ...
    'success': [{ type: core.Output },],
    'error': [{ type: core.Output },],
    'emptyListImageUrl': [{ type: core.Input },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var CreateProcessAttachmentComponent = /** @class */ (function () {
    ...
    CreateProcessAttachmentComponent.prototype.onFileUpload = function (event) {
        var _this = this;
        var /** @type {?} */ filesList = event.detail.files.map(function (obj) { return obj.file; });
        for (var _d = 0, filesList_1 = filesList; _d < filesList_1.length; _d++) {
            var fileInfoObj = filesList_1[_d];
            var /** @type {?} */ file = fileInfoObj;
            var /** @type {?} */ opts = {
                isRelatedContent: true
            };
...
var AttachmentComponent = /** @class */ (function () {
    ...
    AttachmentComponent.prototype.onFileUpload = function (event) {
        var _this = this;
        var /** @type {?} */ filesList = event.detail.files.map(function (obj) { return obj.file; });
        for (var _d = 0, filesList_2 = filesList; _d < filesList_2.length; _d++) {
            var fileInfoObj = filesList_2[_d];
            var /** @type {?} */ file = fileInfoObj;
            var /** @type {?} */ opts = {
                isRelatedContent: true
            };
 ...
 * @nocollapse
 */
AttachmentModule.ctorParameters = function () { return []; };
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 *
 ...
 * @nocollapse
 */
ProcessModule.ctorParameters = function () { return []; };
...
exports.ɵbf = AppsListComponent;
exports.ɵbi = CreateProcessAttachmentComponent;
exports.ɵbj = AttachmentComponent;
exports.ɵbh = ProcessAttachmentListComponent;
exports.ɵbg = TaskAttachmentListComponent;
exports.ɵd = CommentListComponent;
exports.ɵe = CommentsComponent;
exports.ɵc = ProcessCommentsComponent;
exports.ɵb = MaterialModule;
exports.ɵa = modules;
exports.ɵj = PeopleListComponent;
exports.ɵi = PeopleSearchActionLabelDirective;
exports.ɵg = PeopleSearchComponent;
exports.ɵh = PeopleSearchTitleDirective;
exports.ɵf = PeopleComponent;
exports.ɵbd = ProcessAuditDirective;
exports.ɵy = ProcessFiltersComponent;
exports.ɵba = ProcessInstanceDetailsComponent;
exports.ɵbb = ProcessInstanceHeaderComponent;
exports.ɵbc = ProcessInstanceTasksComponent;
exports.ɵw = ProcessInstanceListComponent;
exports.ɵbe = StartProcessInstanceComponent;
exports.ɵz = ProcessFilterService;
exports.ɵx = ProcessService;
exports.ɵr = ChecklistComponent;
exports.ɵk = NoTaskDetailsTemplateDirective;
exports.ɵt = StartTaskComponent;
exports.ɵq = TaskAuditDirective;
exports.ɵl = TaskDetailsComponent;
exports.ɵn = TaskFiltersComponent;
exports.ɵs = TaskHeaderComponent;
exports.ɵp = TaskListComponent;
exports.ɵv = ProcessUploadService;
exports.ɵo = TaskFilterService;
exports.ɵu = TaskUploadService;
exports.ɵm = TaskListService;
