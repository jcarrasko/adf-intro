 ...
 */
import { DataCellEvent, DataRowActionEvent, DataTableComponent, PaginatedComponent, PaginationQueryParams } from '@alfresco/adf-core';
...
export declare class DocumentListComponent implements OnInit, OnChanges, OnDestroy, AfterContentInit, PaginatedComponent {
    ...
    private onDataReady(page);
    updatePagination(params: PaginationQueryParams): void;
