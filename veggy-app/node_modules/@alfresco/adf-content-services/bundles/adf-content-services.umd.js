(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser/animations'), require('@alfresco/adf-core'), require('@angular/material'), require('rxjs/Observable'), require('rxjs/add/observable/throw'), require('@ngx-translate/core'), require('@angular/flex-layout'), require('rxjs/add/observable/merge'), require('rxjs/Subject'), require('@angular/cdk/keycodes'), require('@angular/platform-browser'), require('rxjs/observable/fromEvent'), require('rxjs/observable/merge'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/forms', '@angular/platform-browser/animations', '@alfresco/adf-core', '@angular/material', 'rxjs/Observable', 'rxjs/add/observable/throw', '@ngx-translate/core', '@angular/flex-layout', 'rxjs/add/observable/merge', 'rxjs/Subject', '@angular/cdk/keycodes', '@angular/platform-browser', 'rxjs/observable/fromEvent', 'rxjs/observable/merge', '@angular/animations'], factory) :
	(factory((global['adf-content-services'] = {}),global.ng.common,global.ng.core,global.ng.forms,global['@angular/platform-browser/animations'],global['@alfresco/adf-core'],global['@angular/material'],global.Rx,global.Rx.Observable,global['@ngx-translate/core'],global['@angular/flex-layout'],global.Rx.Observable,global.Rx,global.ng.cdk.keycodes,global.ng.platformBrowser,global.Rx.Observable,global.Rx.Observable,global['@angular/animations']));
}(this, (function (exports,common,core,forms,animations,adfCore,material,Observable,_throw,core$1,flexLayout,merge,Subject,keycodes,platformBrowser,fromEvent,merge$1,animations$1) { 'use strict';
...
var RatingComponent = /** @class */ (function () {
    ...
    RatingComponent.prototype.ngOnChanges = function () {
        var _this = this;
        var /** @type {?} */ ratingObserver = this.ratingService.getRating(this.nodeId, this.ratingType);
...
var TagService = /** @class */ (function () {
    ...
    TagService.prototype.addTag = function (nodeId, tagName) {
        var _this = this;
        var /** @type {?} */ alfrescoApi = this.apiService.getInstance();
        var /** @type {?} */ tagBody = new alfrescoApi.core.TagBody();
        tagBody.tag = tagName;
        var /** @type {?} */ promiseAdd = Observable.Observable.fromPromise(this.apiService.getInstance().core.tagsApi.addTag(nodeId, tagBody));
    ...
    TagService.prototype.removeTag = function (nodeId, tag) {
        var _this = this;
        var /** @type {?} */ promiseRemove = Observable.Observable.fromPromise(this.apiService.getInstance().core.tagsApi.removeTag(nodeId, tag));
...
var FileUploadingListComponent = /** @class */ (function () {
    ...
    FileUploadingListComponent.prototype.notifyError = function () {
        ...
        for (var _d = 0; _d < arguments.length; _d++) {
            files[_d] = arguments[_d];
        }
        var /** @type {?} */ translateSubscription = null;
        if (files.length === 1) {
    ...
    FileUploadingDialogComponent.prototype.ngOnInit = function () {
        ...
        this.uploadService.fileDeleted.subscribe(function (objId) {
            if (_this.filesUploadingList) {
                var /** @type {?} */ file = _this.filesUploadingList.find(function (item) {
...
FileUploadingDialogComponent.propDecorators = {
    'uploadList': [{ type: core.ViewChild, args: [FileUploadingListComponent,] },],
...
var UploadButtonComponent = /** @class */ (function () {
     ...
     * @param {?} apiService
     */
    function UploadButtonComponent(uploadService, translateService, logService, apiService) {
        this.uploadService = uploadService;
        this.translateService = translateService;
        this.logService = logService;
        this.apiService = apiService;
        ...
        this.permissionValue = new Subject.Subject();
    }
    /**
     * @return {?}
     */
    ...
    UploadButtonComponent.prototype.ngOnChanges = function (changes) {
        var /** @type {?} */ rootFolderId = changes['rootFolderId'];
    ...
    UploadButtonComponent.prototype.onFilesAdded = function ($event) {
        var /** @type {?} */ files = adfCore.FileUtils.toFileArray($event.currentTarget.files);
    ...
    UploadButtonComponent.prototype.uploadFiles = function (files) {
        var /** @type {?} */ latestFilesAdded = files
            .map(this.createFileModel.bind(this))
            .filter(this.isFileAcceptable.bind(this))
            .filter(this.isFileSizeAcceptable.bind(this));
        if (latestFilesAdded.length > 0) {
            (_d = this.uploadService).addToQueue.apply(_d, latestFilesAdded);
    ...
    UploadButtonComponent.prototype.isFileAcceptable = function (file) {
        ...
        var /** @type {?} */ allowedExtensions = this.acceptedFilesType
            .split(',')
 ...
 * limitations under the License.
 */
var UploadDragAreaComponent = /** @class */ (function () {
    /**
     * @param {?} uploadService
     * @param {?} translateService
     * @param {?} notificationService
    ...
    UploadDragAreaComponent.prototype.onFilesDropped = function (files) {
        ...
        if (!this.disabled && files.length) {
            var /** @type {?} */ fileModels = files.map(function (file) { return new adfCore.FileModel(file, {
                newVersion: _this.versioning,
                path: '/',
                parentId: _this.parentId
            }); });
            (_d = this.uploadService).addToQueue.apply(_d, fileModels);
            this.uploadService.uploadFilesInTheQueue(this.success);
        }
        var _d;
    };
    ...
    UploadDragAreaComponent.prototype.onFilesEntityDropped = function (item) {
        ...
        if (!this.disabled) {
            item.file(function (file) {
                var /** @type {?} */ fileModel = new adfCore.FileModel(file, {
                    newVersion: _this.versioning,
                    parentId: _this.parentId,
    ...
    UploadDragAreaComponent.prototype.onFolderEntityDropped = function (folder) {
        ...
        if (!this.disabled && folder.isDirectory) {
            adfCore.FileUtils.flattern(folder).then(function (entries) {
                var /** @type {?} */ files = entries.map(function (entry) {
                ...
                (_d = _this.uploadService).addToQueue.apply(_d, files);
                _this.uploadService.uploadFilesInTheQueue(_this.success);
                var _d;
            });
        }
    ...
    UploadDragAreaComponent.prototype.showUndoNotificationBar = function (latestFilesAdded) {
        var _this = this;
        var /** @type {?} */ messageTranslate, /** @type {?} */ actionTranslate;
        ...
        this.notificationService.openSnackMessageAction(messageTranslate.value, actionTranslate.value, 3000).onAction().subscribe(function () {
            (_d = _this.uploadService).cancelUpload.apply(_d, latestFilesAdded);
            var _d;
        });
    };
    /**
    ...
    UploadDragAreaComponent.prototype.onUploadFiles = function (event) {
        ...
        var /** @type {?} */ isAllowed = this.hasCreatePermission(event.detail.data.obj.entry);
        if (isAllowed) {
            var /** @type {?} */ files = event.detail.files;
            if (files && files.length > 0) {
                var /** @type {?} */ parentId_1 = this.parentId;
                if (event.detail.data && event.detail.data.obj.entry.isFolder) {
                    parentId_1 = event.detail.data.obj.entry.id || this.parentId;
                }
                var /** @type {?} */ fileModels = files.map(function (fileInfo) { return new adfCore.FileModel(fileInfo.file, {
                    newVersion: _this.versioning,
    ...
    UploadDragAreaComponent.prototype.uploadFiles = function (files) {
        if (files.length) {
            (_d = this.uploadService).addToQueue.apply(_d, files);
            this.uploadService.uploadFilesInTheQueue(this.success);
        }
        var _d;
    };
    ...
    UploadDragAreaComponent.prototype.hasCreatePermission = function (node) {
        var /** @type {?} */ isPermitted = false;
        if (node && node['allowableOperations']) {
            var /** @type {?} */ permFound = node['allowableOperations'].find(function (element) { return element === 'create'; });
...
var FileDraggableDirective = /** @class */ (function () {
    ...
    FileDraggableDirective.prototype.onDropFiles = function (event) {
        if (this.enabled && !event.defaultPrevented) {
            ...
            var /** @type {?} */ items = event.dataTransfer.items;
            if (items) {
                for (var /** @type {?} */ i = 0; i < items.length; i++) {
                    if (typeof items[i].webkitGetAsEntry !== 'undefined') {
                        var /** @type {?} */ item = items[i].webkitGetAsEntry();
                        if (item) {
                            if (item.isFile) {
                        ...
                        var /** @type {?} */ files = adfCore.FileUtils.toFileArray(event.dataTransfer.files);
...
var ShareDataTableAdapter = /** @class */ (function () {
    ...
    ShareDataTableAdapter.prototype.getValue = function (row, col) {
        ...
        if (col.type === 'date') {
            try {
                var /** @type {?} */ result = this.formatDate(col, value);
        ...
        if (col.key === '$thumbnail') {
            if (this.imageResolver) {
                var /** @type {?} */ resolved = this.imageResolver(row, col);
                if (resolved) {
                    return resolved;
                }
            }
            var /** @type {?} */ node = ((row)).node;
            ...
            if (node.entry.content) {
                var /** @type {?} */ mimeType = node.entry.content.mimeType;
                if (mimeType) {
    ...
    ShareDataTableAdapter.prototype.formatDate = function (col, value) {
        if (col.type === 'date') {
            ...
            if (format === 'timeAgo') {
                var /** @type {?} */ timeAgoPipe = new adfCore.TimeAgoPipe();
    ...
    ShareDataTableAdapter.prototype.sort = function (key, direction) {
        var /** @type {?} */ sorting = this.sorting || new adfCore.DataSorting();
        if (key) {
            sorting.key = key;
    ...
    ShareDataTableAdapter.prototype.loadPage = function (page, merge$$1) {
        ...
        var /** @type {?} */ rows = [];
        if (page && page.list) {
            var /** @type {?} */ data = page.list.entries;
            if (data && data.length > 0) {
                ...
                if (this.columns && this.columns.length > 0) {
                    var /** @type {?} */ sorting = this.getSorting();
                    if (sorting) {
                        this.sortRows(rows, sorting);
                    }
                    else {
                        var /** @type {?} */ sortable = this.columns.filter(function (c) { return c.sortable; });
...
var DocumentListService = /** @class */ (function () {
    ...
    DocumentListService.prototype.getNodesPromise = function (folder, opts) {
        var /** @type {?} */ rootNodeId = DocumentListService.ROOT_ID;
    ...
    DocumentListService.prototype.createFolder = function (name, parentId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().nodes.createFolder(name, '/', parentId))
            .catch(function (err) { return _this.handleError(err); });
    };
    /**
    ...
    DocumentListService.prototype.getFolder = function (folder, opts) {
        var _this = this;
        return Observable.Observable.fromPromise(this.getNodesPromise(folder, opts))
    ...
    DocumentListService.prototype.getFolderNode = function (nodeId) {
        ...
        var /** @type {?} */ nodes = this.apiService.getInstance().nodes;
...
var DocumentListComponent = /** @class */ (function () {
    ...
    function DocumentListComponent(documentListService, ngZone, elementRef, apiService, appConfig, preferences) {
        ...
        this.pagination = new Subject.Subject();
        this.layoutPresets = {};
    ...
    DocumentListComponent.prototype.getContextActions = function (node) {
        var _this = this;
        if (node && node.entry) {
            var /** @type {?} */ actions = this.getNodeActions(node);
    ...
    DocumentListComponent.prototype.ngAfterContentInit = function () {
        ...
        var /** @type {?} */ columns = this.data.getColumns();
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.reload = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        this.ngZone.run(function () {
            _this.resetSelection();
            if (_this.folderNode) {
                _this.loadFolder(merge$$1);
            }
            else if (_this.currentFolderId) {
                _this.loadFolderByNodeId(_this.currentFolderId, merge$$1);
            }
            else if (_this.node) {
    ...
    DocumentListComponent.prototype.getNodeActions = function (node) {
        ...
        if (node && node.entry) {
            ...
            if (target) {
                var /** @type {?} */ ltarget_1 = target.toLowerCase();
                var /** @type {?} */ actionsByTarget = this.actions.filter(function (entry) {
    ...
    DocumentListComponent.prototype.checkPermission = function (node, action) {
        if (action.permission) {
            if (this.hasPermissions(node)) {
                var /** @type {?} */ permissions = node.entry.allowableOperations;
                var /** @type {?} */ findPermission = permissions.find(function (permission) { return permission === action.permission; });
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadFolder = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        if (merge$$1) {
        ...
        var /** @type {?} */ nodeId = this.folderNode ? this.folderNode.id : this.currentFolderId;
        if (!this.hasCustomLayout) {
            this.setupDefaultColumns(nodeId);
        }
        if (nodeId) {
            this.loadFolderNodesByFolderNodeId(nodeId, this.maxItems, this.skipCount, merge$$1).catch(function (err) { return _this.error.emit(err); });
        }
    };
    /**
     * @param {?} nodeId
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadFolderByNodeId = function (nodeId, merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        this.loading = true;
        this.resetSelection();
        if (nodeId === '-trashcan-') {
            ...
            this.documentListService
                ...
                return _this.loadFolderNodesByFolderNodeId(node.id, _this.maxItems, _this.skipCount, merge$$1);
            })
                .catch(function (err) {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadFolderNodesByFolderNodeId = function (id, maxItems, skipCount, merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        return new Promise(function (resolve, reject) {
            _this.resetSelection();
            _this.documentListService
                ...
                _this.data.loadPage(/** @type {?} */ (val), merge$$1);
                _this.loading = false;
                _this.infiniteLoading = false;
                _this.onDataReady(val);
                resolve(true);
            }, function (error) {
                reject(error);
            });
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.isSkipCountChanged = function (changePage) {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.isMaxItemsChanged = function (changePage) {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadTrashcan = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        var /** @type {?} */ options = {
        ...
        this.apiService.nodesApi.getDeletedNodes(options)
            .then(function (page) { return _this.onPageLoaded(page, merge$$1); })
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadSharedLinks = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        var /** @type {?} */ options = {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadSites = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        var /** @type {?} */ options = {
            include: ['properties'],
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadMemberSites = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        var /** @type {?} */ options = {
            include: ['properties'],
        ...
        this.apiService.peopleApi.getSiteMembership('-me-', options)
            ...
            _this.onPageLoaded(page, merge$$1);
        })
            .catch(function (error) { return _this.error.emit(error); });
    };
    /**
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadFavorites = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        var /** @type {?} */ options = {
            maxItems: this.maxItems,
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.loadRecent = function (merge$$1) {
        var _this = this;
        if (merge$$1 === void 0) { merge$$1 = false; }
        this.apiService.peopleApi.getPerson('-me-')
            .then(function (person) {
            var /** @type {?} */ username = person.entry.id;
            var /** @type {?} */ query = {
                query: {
                    query: '*',
                    language: 'afts'
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.onPageLoaded = function (page, merge$$1) {
        if (merge$$1 === void 0) { merge$$1 = false; }
        if (page) {
    ...
    DocumentListComponent.prototype.onNodeClick = function (node) {
        var /** @type {?} */ domEvent = new CustomEvent('node-click', {
            detail: {
                sender: this,
                node: node
            },
        ...
        var /** @type {?} */ event = new NodeEntityEvent(node);
    ...
    DocumentListComponent.prototype.onNodeDblClick = function (node) {
        var /** @type {?} */ domEvent = new CustomEvent('node-dblclick', {
            detail: {
                sender: this,
                node: node
            },
    ...
    DocumentListComponent.prototype.onNodeSelect = function (event) {
        ...
        var /** @type {?} */ domEvent = new CustomEvent('node-select', {
            detail: {
                node: event.row.node,
    ...
    DocumentListComponent.prototype.onNodeUnselect = function (event) {
        this.selection = event.selection.map(function (entry) { return entry.node; });
        var /** @type {?} */ domEvent = new CustomEvent('node-unselect', {
            detail: {
                node: event.row.node,
                selection: this.selection
            },
    ...
    DocumentListComponent.prototype.getDefaultSorting = function () {
        var /** @type {?} */ defaultSorting;
        if (this.sorting) {
            var _d = this.sorting, key = _d[0], direction = _d[1];
    ...
    DocumentListComponent.prototype.isCustomSource = function (folderId) {
        var /** @type {?} */ sources = ['-trashcan-', '-sharedlinks-', '-sites-', '-mysites-', '-favorites-', '-recent-'];
    ...
    DocumentListComponent.prototype.hasCurrentNodePermission = function (permission) {
        ...
        if (this.currentNodeAllowableOperations.length > 0) {
            var /** @type {?} */ permFound = this.currentNodeAllowableOperations.find(function (element) { return element === permission; });
    ...
    DocumentListComponent.prototype.loadLayoutPresets = function () {
        var /** @type {?} */ externalSettings = this.appConfig.get('document-list.presets', null);
        if (externalSettings) {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.onDataReady = function (page) {
     ...
     * @return {?}
     */
    DocumentListComponent.prototype.updatePagination = function (params) {
        var /** @type {?} */ needsReload = this.maxItems !== params.maxItems || this.skipCount !== params.skipCount;
...
DocumentListComponent.propDecorators = {
    ...
    'error': [{ type: core.Output },],
    'dataTable': [{ type: core.ViewChild, args: [adfCore.DataTableComponent,] },],
...
var ContentNodeSelectorComponent = /** @class */ (function () {
     ...
     */
    function ContentNodeSelectorComponent(contentNodeSelectorService, contentService, apiService, preferences, data, containingDialog) {
        var _this = this;
    ...
    ContentNodeSelectorComponent.prototype.needBreadcrumbs = function () {
        var /** @type {?} */ whenInFolderNavigation = !this.showingSearchResults, /** @type {?} */ whenInSelectingSearchResult = this.showingSearchResults && this.chosenNode;
     ...
     * @return {?}
     */
    ContentNodeSelectorComponent.prototype.onFolderLoaded = function (nodePage) {
    ...
    ContentNodeSelectorComponent.prototype.choose = function () {
        var _this = this;
        var /** @type {?} */ entry = this.chosenNode;
        if (entry && entry.guid) {
            var /** @type {?} */ options = {
                include: ['path', 'properties', 'allowableOperations']
            };
            this.apiService.nodesApi.getNode(entry.guid, options)
                .then(function (chosenSiteNode) {
                _this.select.next([chosenSiteNode.entry]);
            });
        }
        else {
     ...
     * @return {?}
     */
    ContentNodeSelectorComponent.prototype.onNodeDoubleClick = function (e) {
        var _this = this;
        var /** @type {?} */ node = e.detail.node.entry;
        if (node && node.guid) {
            var /** @type {?} */ options = {
...
ContentNodeSelectorComponent.ctorParameters = function () { return [
    ...
    { type: material.MatDialogRef, decorators: [{ type: core.Optional },] },
]; };
ContentNodeSelectorComponent.propDecorators = {
    ...
    'documentList': [{ type: core.ViewChild, args: [DocumentListComponent,] },],
...
var NodeActionsService = /** @class */ (function () {
    ...
    NodeActionsService.prototype.doFileOperation = function (action, type, contentEntry, permission) {
        var _this = this;
        var /** @type {?} */ observable = new Subject.Subject();
        if (this.contentService.hasPermission(contentEntry, permission)) {
            var /** @type {?} */ data = {
                ...
                select: new core.EventEmitter()
            };
            this.dialog.open(ContentNodeSelectorComponent, { data: data, panelClass: 'adf-content-node-selector-dialog', width: '630px' });
            data.select.subscribe(function (selections) {
                var /** @type {?} */ selection = selections[0];
...
var DocumentActionsService = /** @class */ (function () {
     ...
     * @return {?}
     */
    DocumentActionsService.prototype.download = function (node) {
        ...
        return Observable.Observable.of(false);
    };
    /**
     * @param {?} node
     * @param {?=} target
    ...
    DocumentActionsService.prototype.copyNode = function (node, target, permission) {
        var /** @type {?} */ actionObservable = this.nodeActionsService.copyContent(node.entry, permission);
    ...
    DocumentActionsService.prototype.moveNode = function (node, target, permission) {
        var /** @type {?} */ actionObservable = this.nodeActionsService.moveContent(node.entry, permission);
        ...
        if (this.canExecuteAction(node)) {
            if (this.contentService.hasPermission(node.entry, permission)) {
                ...
                handlerObservable.subscribe(function () {
                    ...
                    _this.success.next(node.entry.id);
                });
...
var FolderActionsService = /** @class */ (function () {
    ...
    FolderActionsService.prototype.copyNode = function (obj, target, permission) {
        var /** @type {?} */ actionObservable = this.nodeActionsService.copyFolder(obj.entry, permission);
    ...
    FolderActionsService.prototype.moveNode = function (obj, target, permission) {
        var /** @type {?} */ actionObservable = this.nodeActionsService.moveFolder(obj.entry, permission);
...
var ContentActionComponent = /** @class */ (function () {
    ...
    ContentActionComponent.prototype.getSystemHandler = function (target, name) {
        var _this = this;
        if (target) {
            var /** @type {?} */ ltarget = target.toLowerCase();
            if (ltarget === 'document') {
...
var ContentColumnListComponent = /** @class */ (function () {
    ...
    ContentColumnListComponent.prototype.registerColumn = function (column) {
        if (this.documentList && column) {
            var /** @type {?} */ columns = this.documentList.data.getColumns();
            columns.push(column);
            return true;
        }
        return false;
...
var SearchTriggerDirective = /** @class */ (function () {
    ...
    SearchTriggerDirective.prototype.handleInput = function (event) {
        if (document.activeElement === event.target) {
            var /** @type {?} */ inputValue = ((event.target)).value;
    ...
    SearchTriggerDirective.prototype.subscribeToClosingActions = function () {
        var _this = this;
        var /** @type {?} */ firstStable = this.ngZone.onStable.asObservable();
        var /** @type {?} */ optionChanges = this.searchPanel.keyPressedStream.asObservable();
    ...
    SearchTriggerDirective.prototype.setTriggerValue = function (value) {
        var /** @type {?} */ toDisplay = this.searchPanel && this.searchPanel.displayWith ?
...
var SearchComponent = /** @class */ (function () {
     ...
     * @param {?} _elementRef
     */
    function SearchComponent(searchService, changeDetectorRef, _elementRef) {
        var _this = this;
        this.searchService = searchService;
        this.changeDetectorRef = changeDetectorRef;
     ...
     * @return {?}
     */
    SearchComponent.prototype.hasValidSearchQuery = function (searchOpts) {
    ...
    SearchComponent.prototype.loadSearchResults = function (searchTerm) {
        var _this = this;
        var /** @type {?} */ searchOpts = this.getQueryBody(searchTerm);
        if (this.hasValidSearchQuery(searchOpts)) {
            this.searchService
                .search(searchOpts)
                .subscribe(function (results) {
                _this.results = /** @type {?} */ (results);
                _this.resultLoaded.emit(_this.results);
                _this.isOpen = true;
                _this.setVisibility();
            }, function (error) {
                if (error.status !== 400) {
     ...
     * @return {?}
     */
    SearchComponent.prototype.getQueryBody = function (searchTerm) {
        if (this.queryBody) {
     ...
     * @return {?}
     */
    SearchComponent.prototype.generateDefaultSearchNode = function (searchTerm) {
        var /** @type {?} */ defaultQueryBody = {
            query: {
...
var SearchControlComponent = /** @class */ (function () {
    ...
    function SearchControlComponent(authService, thumbnailService) {
        ...
        this.toggleSearch.asObservable().debounceTime(100).subscribe(function () {
            if (_this.expandable) {
    ...
    SearchControlComponent.prototype.selectFirstResult = function () {
        if (this.listResultElement && this.listResultElement.length > 0) {
            var /** @type {?} */ firstElement = (this.listResultElement.first);
    ...
    SearchControlComponent.prototype.onRowArrowDown = function ($event) {
        var /** @type {?} */ nextElement = this.getNextElementSibling(/** @type {?} */ ($event.target));
        if (nextElement) {
            nextElement.focus();
        }
    };
    ...
    SearchControlComponent.prototype.onRowArrowUp = function ($event) {
        var /** @type {?} */ previousElement = this.getPreviousElementSibling(/** @type {?} */ ($event.target));
        if (previousElement) {
    ...
    SearchControlComponent.prototype.setupFocusEventHandlers = function () {
        var _this = this;
        var /** @type {?} */ focusEvents = this.focusSubject.asObservable()
            .debounceTime(50);
    ...
    { type: core.Component, args: [{
                ...
                animations: [
                    animations$1.trigger('transitionMessages', [
                        animations$1.state('active', animations$1.style({ transform: 'translateX(0%)', 'margin-left': '13px' })),
                        animations$1.state('inactive', animations$1.style({ transform: 'translateX(81%)' })),
                        animations$1.state('no-animation', animations$1.style({ transform: 'translateX(0%)', width: '100%' })),
                        animations$1.transition('inactive => active', animations$1.animate('300ms cubic-bezier(0.55, 0, 0.55, 0.2)')),
                        animations$1.transition('active => inactive', animations$1.animate('300ms cubic-bezier(0.55, 0, 0.55, 0.2)'))
                    ])
                ],
                encapsulation: core.ViewEncapsulation.None,
...
SearchControlComponent.propDecorators = {
    ...
    'searchAutocomplete': [{ type: core.ViewChild, args: [SearchComponent,] },],
...
SearchModule.decorators = [
    { type: core.NgModule, args: [{
                ...
                declarations: ALFRESCO_SEARCH_DIRECTIVES.slice(),
                providers: ALFRESCO_SEARCH_PROVIDERS.slice(),
                exports: ALFRESCO_SEARCH_DIRECTIVES.slice()
            },] },
];
/**
 * @nocollapse
...
var DropdownSitesComponent = /** @class */ (function () {
    ...
    DropdownSitesComponent.prototype.selectedSite = function () {
        ...
        if (this.siteSelected === this.MY_FILES_VALUE) {
            siteFound = new adfCore.SiteModel();
        }
        else {
...
var BreadcrumbComponent = /** @class */ (function () {
    ...
    BreadcrumbComponent.prototype.ngOnChanges = function (changes) {
        if (changes.folderNode) {
            var /** @type {?} */ node = changes.folderNode.currentValue;
    ...
    BreadcrumbComponent.prototype.parseRoute = function (node) {
        if (node && node.path) {
            var /** @type {?} */ route = ((node.path.elements || []).slice());
            route.push(/** @type {?} */ ({
                id: node.id,
                name: node.name
            }));
            var /** @type {?} */ rootPos = this.getElementPosition(route, this.rootId);
            if (rootPos > 0) {
...
DropdownBreadcrumbComponent.propDecorators = {
    'selectbox': [{ type: core.ViewChild, args: [material.MatSelect,] },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
...
var DownloadZipDialogComponent = /** @class */ (function () {
        ...
        if (this.data && this.data.nodeIds && this.data.nodeIds.length > 0) {
            ...
            setTimeout(function () {
                if (!_this.cancelled) {
                    ...
                    _this.logService.log('Cancelled');
                }
            }, 0);
        }
    };
    ...
    DownloadZipDialogComponent.prototype.downloadZip = function (nodeIds) {
        ...
        if (nodeIds && nodeIds.length > 0) {
            var /** @type {?} */ promise = this.downloadsApi.createDownload({ nodeIds: nodeIds });
            ...
            promise.on('success', function (data) {
                if (data && data.entry && data.entry.id) {
                    var /** @type {?} */ url_1 = _this.contentApi.getContentUrl(data.entry.id, true);
                    ...
                    _this.nodesApi.getNode(data.entry.id).then(function (downloadNode) {
                        ...
                        var /** @type {?} */ fileName = downloadNode.entry.name;
 ...
 * @return {?}
 */
function forbidSpecialCharacters(_d) {
    var value = _d.value;
    var /** @type {?} */ specialCharacters = /([\*\"\<\>\\\/\?\:\|])/;
    var /** @type {?} */ isValid = !specialCharacters.test(value);
    return (isValid) ? null : {
 ...
 * @return {?}
 */
function forbidEndingDot(_d) {
    var value = _d.value;
    var /** @type {?} */ isValid = ((value || '').trim().split('').pop() !== '.');
    return isValid ? null : {
 ...
 * @return {?}
 */
function forbidOnlySpaces(_d) {
    var value = _d.value;
    var /** @type {?} */ isValid = !!((value || '')).trim();
    return isValid ? null : {
...
var FolderDialogComponent = /** @class */ (function () {
     ...
     * @param {?} data
     */
    function FolderDialogComponent(formBuilder, dialog, nodesApi, translation, notification, data) {
    ...
    Object.defineProperty(FolderDialogComponent.prototype, "properties", {
         ...
         */
        get: function () {
            var _d = this, title = _d.name, description = _d.description;
            return {
                'cm:title': title,
    ...
    FolderDialogComponent.prototype.create = function () {
        var _d = this, name = _d.name, properties = _d.properties, nodesApi = _d.nodesApi, parentNodeId = _d.data.parentNodeId;
    ...
    FolderDialogComponent.prototype.edit = function () {
        var _d = this, name = _d.name, properties = _d.properties, nodesApi = _d.nodesApi, nodeId = _d.data.folder.id;
    ...
    FolderDialogComponent.prototype.submit = function () {
        var _this = this;
        var _d = this, form = _d.form, dialog = _d.dialog, editing = _d.editing;
        if (!form.valid) {
            return;
        }
    ...
    FolderDialogComponent.prototype.handleError = function (error) {
        var _this = this;
        var /** @type {?} */ i18nMessageString = 'CORE.MESSAGES.ERRORS.GENERIC';
        try {
        ...
        this.translation.get(i18nMessageString).subscribe(function (message) {
            _this.notification.openSnackMessage(message, 3000);
        });
        return error;
    };
...
DialogModule.decorators = [
    { type: core.NgModule, args: [{
                ...
                providers: [
                    adfCore.NodesApiService,
                    adfCore.NotificationService,
                    adfCore.TranslationService
                ],
                exports: [
                    DownloadZipDialogComponent,
                    FolderDialogComponent
...
var FolderCreateDirective = /** @class */ (function () {
    ...
    FolderCreateDirective.prototype.openDialog = function () {
        var _d = this, dialogRef = _d.dialogRef, dialogConfig = _d.dialogConfig, content = _d.content;
        var /** @type {?} */ dialogInstance = dialogRef.open(FolderDialogComponent, dialogConfig);
...
var ContentMetadataService = /** @class */ (function () {
     ...
     * @param {?} fileSizePipe
     */
    function ContentMetadataService(fileSizePipe) {
...
var ContentMetadataComponent = /** @class */ (function () {
     ...
     * @param {?} nodesApi
     */
    function ContentMetadataComponent(contentMetadataService, cardViewUpdateService, nodesApi) {
    ...
    ContentMetadataComponent.prototype.ngOnInit = function () {
        ...
        this.cardViewUpdateService.itemUpdated$
            ...
            .subscribe(function (node) { return _this.node = node; }, function (error) { return _this.handleError(error); });
    };
    /**
     * @return {?}
     */
    ContentMetadataComponent.prototype.ngOnChanges = function () {
     ...
     * @return {?}
     */
    ContentMetadataComponent.prototype.saveNode = function (_d) {
        var nodeBody = _d.changed;
     ...
     * @return {?}
     */
    ContentMetadataComponent.prototype.handleError = function (error) {
     ...
     * @return {?}
     */
    ContentMetadataComponent.prototype.recalculateProperties = function () {
        var /** @type {?} */ basicProperties = this.contentMetadataService.getBasicProperties(this.node);
        if (this.maxPropertiesToShow) {
            basicProperties = basicProperties.slice(0, this.maxPropertiesToShow);
        }
        this.properties = basicProperties.slice();
    };
...
ContentMetadataComponent.decorators = [
    { type: core.Component, args: [{
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                encapsulation: core.ViewEncapsulation.None,
                providers: [adfCore.CardViewUpdateService],
                viewProviders: [ContentMetadataService, adfCore.FileSizePipe]
            },] },
];
/**
 * @nocollapse
...
ContentMetadataComponent.propDecorators = {
    ...
    'maxPropertiesToShow': [{ type: core.Input },],
};
/*!
 * @license
 * Copyright 2016 Alfresco Software, Ltd.
 ...
 * limitations under the License.
 */
var PROPERTY_COUNTER_WHILE_COLLAPSED = 5;
var ContentMetadataCardComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ContentMetadataCardComponent.prototype, "maxPropertiesToShow", {
        /**
         * @return {?}
         */
        get: function () {
...
exports.ALFRESCO_SEARCH_PROVIDERS = ALFRESCO_SEARCH_PROVIDERS;
...
exports.ɵbh = DropdownBreadcrumbComponent;
exports.ɵbq = ContentMetadataCardComponent;
exports.ɵbo = ContentMetadataComponent;
exports.ɵbp = ContentMetadataService;
exports.ɵbl = ContentNodeSelectorComponent;
exports.ɵbm = ContentNodeSelectorService;
exports.ɵbr = DownloadZipDialogComponent;
exports.ɵbs = FolderDialogComponent;
exports.ɵbc = ContentActionListComponent;
exports.ɵy = ContentActionComponent;
exports.ɵx = ContentColumnListComponent;
exports.ɵw = ContentColumnComponent;
exports.ɵu = DocumentListComponent;
exports.ɵbd = EmptyFolderContentDirective;
exports.ɵbe = NoPermissionContentDirective;
exports.ɵz = DocumentActionsService;
exports.ɵv = DocumentListService;
exports.ɵbb = FolderActionsService;
exports.ɵba = NodeActionsService;
exports.ɵbt = FolderCreateDirective;
exports.ɵbu = FolderEditDirective;
exports.ɵb = MaterialModule;
exports.ɵa = modules;
exports.ɵl = SearchControlComponent;
exports.ɵm = SEARCH_AUTOCOMPLETE_VALUE_ACCESSOR;
exports.ɵn = SearchTriggerDirective;
exports.ɵk = SearchComponent;
exports.ɵbf = DropdownSitesComponent;
exports.ɵe = LikeComponent;
exports.ɵc = RatingComponent;
exports.ɵd = RatingService;
exports.ɵg = TagService;
exports.ɵf = TagActionsComponent;
exports.ɵh = TagListComponent;
exports.ɵi = TagNodeListComponent;
exports.ɵr = FileUploadingDialogComponent;
exports.ɵt = FileUploadingListRowComponent;
exports.ɵs = FileUploadingListComponent;
exports.ɵq = UploadButtonComponent;
exports.ɵp = UploadDragAreaComponent;
exports.ɵo = FileDraggableDirective;
exports.ɵbk = VersionListComponent;
exports.ɵbj = VersionManagerComponent;
exports.ɵbi = VersionUploadComponent;
exports.ɵj = WebscriptComponent;
